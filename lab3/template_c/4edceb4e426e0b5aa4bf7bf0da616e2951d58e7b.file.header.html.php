  ...
  <head>
    ...
    <body>
      <div class="header">
        ...
        <ul id="topmenu">
          <li class="show">
            <a href="http://htmlbook.ru/#main"><i class="icon icon-main"></i>
            <br>
            Основное</a>
          </li>
          <li class="hide">
            <a href="http://htmlbook.ru/#html"><i class="icon icon-html"></i>
            <br>
            HTML</a>
          </li>
          <li class="hide">
            <a href="http://htmlbook.ru/#css"><i class="icon icon-css"></i>
            <br>
            CSS</a>
          </li>
          <li class="hide">
            <a href="http://htmlbook.ru/#site"><i class="icon icon-site"></i>
            <br>
            Сайт</a>
          </li>
        </ul>
